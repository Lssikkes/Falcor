...
public:
    ...
    void BroadcastResource(CD3DX12AffinityResource* pResourceDst, CD3DX12AffinityResource* pResource, UINT NodeIndex, UINT TargetNodeMask);
	void BroadcastBufferRegion(CD3DX12AffinityResource* pResourceDst, UINT64 DstOffset, CD3DX12AffinityResource* pResourceSrc, UINT64 SrcOffset, UINT64 NumBytes, UINT NodeIndex, UINT TargetNodeMask);
	void BroadcastTextureRegion(CD3DX12AffinityResource* pResourceDst, UINT subResourceDest, CD3DX12AffinityResource* pResourceSrc, UINT subResource, UINT DstX, UINT DstY, UINT DstZ, const D3D12_BOX* SourceBox, UINT NodeIndex, UINT TargetNodeMask);
